...
AREAS = {
    ...
    "regional":{"name":"区域与城乡发展","keywords":["区域","城乡","城市","县域","都市圈","区域协调","城市更新","基础设施","公共资源"]},
...
def score_text(text, selected_areas=None):
    ...
    agencies=uniq_hits(text,["党中央","国务院","全国人大","全国政协","国家发展改革委","财政部","教育部","科技部","工业和信息化部","民政部","人力资源社会保障部","自然资源部","生态环境部","住房城乡建设部","交通运输部","国家数据局","商务部","国家卫生健康委","国家统计局","市场监管总局","地方政府","省级政府","市级政府"])
    ...
    objects=uniq_hits(text,["企业","中小企业","居民","老年人","儿童","青年","农民","低收入群体","困难群体","基层政府","社区","学校","医院","科研机构","行业协会","平台企业","地方政府","县域","基层地区","城市社区"])
    ...
    actors=uniq_hits(text,["国务院","国家发展改革委","财政部","教育部","科技部","工业和信息化部","民政部","人力资源社会保障部","自然资源部","生态环境部","住房城乡建设部","交通运输部","国家数据局","商务部","国家卫生健康委","国家统计局","省级政府","市级政府","县级政府","牵头部门","责任部门","第三方机构"])
...
def proofread_text(text):
    ...
    actor_words=["国务院","国家发展改革委","财政部","教育部","科技部","工业和信息化部","民政部","人力资源社会保障部","自然资源部","生态环境部","住房城乡建设部","交通运输部","国家数据局","商务部","国家卫生健康委","省级政府","市级政府","县级政府","牵头部门","责任部门"]
